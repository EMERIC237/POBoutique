...
import com.pembo.store.validation.ValidUserRole;
...
public record UserDto(Long id,
                      ...
                      @NotNull @Size(message = "incorrect password length", min = 6, max = 255) @NotEmpty(message =
                              "Password cannot be empty") @NotBlank String password,
                      @NotNull @Size(max = 255) @Email(message = "Incorrect email") @NotBlank(message = "Email cannot" +
                              " be empty") String email,
                      @ValidUserRole String role,
