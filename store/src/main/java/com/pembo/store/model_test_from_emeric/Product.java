...
public class Product {
    ...
    // add a product to order items
    public void addOrderItem(OrderItem orderItem) {
        orderItems.add(orderItem);
        orderItem.setProduct(this);
    }

    // remove a product from order items
    ...
    public String toString() {
        return "Product{" + "id=" + id + ", name='" + name + '\'' + ", description='" + description + '\'' + ", price=" + price + ", stockQuantity=" + stockQuantity + ", imageUrl='" + imageUrl + '\'' + ", productCategories=" + productCategories + ", cartItems=" + cartItems + ", reviews=" + reviews + ", orderItems=" + orderItems + '}';
    }
}
